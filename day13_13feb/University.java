...
public class University {
    public static void main(String[] args) {
        ...
        while (true) {
            ...
            switch (choice) {
                case 1:
                    Student student = addstudent(sc);               //adding new student using a function
                    if (student != null) {
    ...
    public  static Student addstudent(Scanner sc) {
        ...
        sc.nextLine();
        System.out.println("Enter number  of courses you study:");
        int numbr= sc.nextByte();
        List<String> courses=new ArrayList<>(numbr);
